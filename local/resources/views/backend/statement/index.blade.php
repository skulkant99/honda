            ...
            <div class="card-body">
                ...
                <table id="data-table" class="table table-bordered dt-responsive" style="width: 100%;">
                  ...
                  <tbody>
                    ...
                    @foreach($sta as $key=>$c)
                    <tr>
                      <td>{{$key+1}}</td>
                      <td>
                        <img src="{{ asset('local/public/state_img').'/'.$c->banner_img }}" height="50">
                      </td>
                      <td>
                        <a href="{{url('backend/edit_state_banner')}}" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i></a>
                      </td>
