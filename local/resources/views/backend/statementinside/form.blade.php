...
@section('title') STATEAMENT AND VISION/ EDIT INSIDE DETAILS @endsection
@section('css')
...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-0 font-size-18">EDIT INSIDE DETAILS</h4>
<!-- 
...
<div class="row">
    <div class="col-10">
        <div class="card">
            <div class="card-body">
              @if( empty($sRow) )
              <form action="{{ route('backend.statementinside.store') }}" method="POST" enctype="multipart/form-data" autocomplete="off">
              @else
              <form action="{{ route('backend.statementinside.update', $sRow[0]->id ) }}" method="POST" enctype="multipart/form-data" autocomplete="off">
 ...
 <div class="myBorder">
            ...
            @endif
                ...
                @if( ($sRow[$i]->group_id) == 1)
                <div class="form-group row">
                    <label for="example-text-input" class="col-md-2 col-form-label">Topic2 :</label>
                    <div class="col-md-10">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10 mt-2">
                      <div class="custom-control custom-switch">
                            <textarea name="detail[]" class="ckeditor">{{$sRow[$i]->detail??'' }}</textarea>
                      </div>
                    </div>
                </div>
                 ...
                 <div class="form-group row">
                    <label class="col-md-2 col-form-label">Detail2  :</label>
                    <div class="col-md-10 mt-2">
                      <div class="custom-control custom-switch">
                            <textarea name="detail2[]" class="ckeditor">{{$sRow[$i]->detail2??'' }}</textarea>
                      </div>
                    </div>
                </div>
   ...
   @endfor              
                <div class="form-group mb-0 row">
                    <div class="col-md-6">
                        <a class="btn btn-secondary btn-sm waves-effect" href="{{ url('backend/statementinside') }}">
...
<script>$('.select2-templating').select2();</script>  
<script>
