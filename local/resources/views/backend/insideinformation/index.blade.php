            ...
            <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-4 text-right">
                    <a class="btn btn-info btn-sm mt-1" href="{{ route('backend.insideinformation.create') }}">
...
$(function() {
    ...
    "sDom": "<'row'<'col-sm-12'tr>><'row'<'col-sm-5'i><'col-sm-7'p>>",
        ...
        iDisplayLength: 25,
        ajax: {
          url: '{{ route('backend.insideinformation.datatable') }}',
          data: function ( d ) {
            d.Where={};
        ...
        columns: [
            ...
            {data: 'evaluation_result', title :'<center>Evaluation Result</center>', className: 'text-center'},
        ...
        rowCallback: function(nRow, aData, dataIndex){
          $('td:last-child', nRow).html(''
            + '<a href="{{ route('backend.insideinformation.index') }}/'+aData['id']+'/edit" class="btn btn-sm btn-primary"><i class="bx bx-edit font-size-16 align-middle"></i></a> '
