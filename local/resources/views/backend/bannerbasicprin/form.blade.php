...
@section('title') Basic principles and directions | EDIT BANNER @endsection
...
<div class="row">
    <div class="col-10">
        <div class="card">
            <div class="card-body">
              @if( empty($sRow) )
              <form action="{{ route('backend.bannerbasicprin.store') }}" method="POST" enctype="multipart/form-data" autocomplete="off">
              @else
              <form action="{{ route('backend.bannerbasicprin.update', $sRow[0]->id ) }}" method="POST" enctype="multipart/form-data" autocomplete="off">
...
<div class="myBorder"> 
 ...
 @endfor
                ...
                <div class="form-group mb-0 row">
                    <div class="col-md-6">
                        <a class="btn btn-secondary btn-sm waves-effect" href="{{ url('backend/bannerbasicprin') }}">
