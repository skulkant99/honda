            ...
            <div class="card-body">
                ...
                <table id="data-table" class="table table-bordered dt-responsive" style="width: 100%;">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>1</td>
                      <td>{{$cont->cont_head}}</td>
                      <td>{{$cont->cont_title}}</td>
                      <td>{{$cont->cont_update}}</td>
                      <td>
                        <a href="{{url('backend/banner_image')}}" class="btn btn-sm btn-info"><i class="fa fa-file-image"></i></a>
                      </td>
                      <td>
                        <a href="{{url('backend/edit-cont-home')}}" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i></a>
                      </td>
