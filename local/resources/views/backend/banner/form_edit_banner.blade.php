    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <div class="row">
                  <div class="col-12">
                      <form action="{{ url('backend/update_banner') }}" method="POST" autocomplete="off" enctype="multipart/form-data">
                      ...
                      <div class="form-group row">
                        <label for="example-email-input" class="col-md-4 col-form-label">UPLOAD IMAGE FILE (1600*800) :</label>
                        <div class="col-md-8">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-8">
                          <img style="height: 200px" id="blah" src="{{ asset('local/public/img_banner').'/'.$banner->banner_img }}" alt="your image" />
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-10" align="right">
                          <a href="{{url('backend/banner_image')}}" class="btn btn-sm btn-warning"><i class="fa fa-caret-left"></i> ย้อนกลับ</a>
