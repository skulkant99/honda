            ...
            <div class="card-body">
                ...
                <table id="data-table" class="table table-bordered dt-responsive" style="width: 100%;">
                  ...
                  <tbody>
                    ...
                    {{-- @foreach($his as $key=>$data) --}}
                    <tr>
                      <td>1</td>
                      <td>
                        <img height="100" src="{{ asset('local/public/history_img').'/'.$his->his_img_bag }}">
                      </td>
                      <td>
                        <img height="100" src="{{ asset('local/public/history_img').'/'.$his->his_img_pro1 }}">
                      </td>
                      <td>{{$his->his_pos}}</td>
                      <td>
                        <a href="{{url('backend/edit_history')}}" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i></a>
                      </td>
                    </tr>
                    {{-- @endforeach --}}
                  </tbody>
