            ...
            <div class="card-body">
                ...
                <table id="data-table" class="table table-bordered dt-responsive" style="width: 100%;">
                  ...
                  <tbody align="center">
                    ...
                    <tr>
                      <td>{{$key+1}}</td>
                      <td> <img width="20%" src="{{asset('backend/images/business_banner').'/'.$c->image}}">  </td>
                      <td>
                        <a href="{{url('backend/edit-business_banner',$c -> id)}}" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i></a>
                      </td>
