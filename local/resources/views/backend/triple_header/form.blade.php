...
@section('title') TRIPLE ZERO APPROACH | EDIT HEADER @endsection
...
<div class="row">
    <div class="col-10">
        <div class="card">
            <div class="card-body">
              @if( empty($sRow) )
              <form action="{{ route('backend.triple_header.store') }}" method="POST" enctype="multipart/form-data" autocomplete="off">
              @else
              <form action="{{ route('backend.triple_header.update', $sRow[0]->id ) }}" method="POST" enctype="multipart/form-data" autocomplete="off">
  ...
  <div class="myBorder">
            ...
            @endif      
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <textarea class="form-control" rows="4" type="text"name="content[]" > {{$sRow[$i]->content??'' }}
                        </textarea> 
                    </div>
                </div>
</div>
   @endfor 
                ...
                <div class="form-group mb-0 row">
                    <div class="col-md-6">
                        <a class="btn btn-secondary btn-sm waves-effect" href="{{ url('backend/triple_header') }}">
