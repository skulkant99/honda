            ...
            <div class="card-body">
                <div class="row">
                  <div class="col-12">
                    ...
                    <form action="{{ url('backend/update-enviimpact_inside',$inside) }}" method="POST" autocomplete="off">
     {{ csrf_field() }}
    @method('put')
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-10 ">
                          ...
                          <input class="form-control" value="{{$inside}}" name="inside">
                        </div>
                      </div>
                      <div class="form-group row">
    ...
    @method('put')
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-10 ">
                          <input class="form-control" value="" name="year">
                          <input class="form-control" value="{{$inside}}" name="inside">
                           <input class="form-control" value="2" name="topic">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label  class="col-md-2 col-form-label">Value </label>
