                ...
                <table id="data-table" class="table table-bordered dt-responsive" style="width: 100%;">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>1</td>
                      <td>
                        <img height="100" src="{{ asset('local/public/sus_img').'/'.$sus->sus_img_bag }}">
                      </td>
                      <td>
                        <img height="100" src="{{ asset('local/public/sus_img').'/'.$sus->sus_img }}"></td>
                      <td>{{$sus->sus_topic}}</td>
                      <td>
                        <a href="{{url('backend/edit_sus1')}}" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i></a>
                      </td>
