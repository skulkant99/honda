...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-0 font-size-18">NEWS MENU</h4>
                ...
                <table id="data-table" class="table table-bordered dt-responsive" style="width: 100%;">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>{{$key+1}}</td>
                      <td>
                        <img height="100" src="{{ asset('local/public/env_img').'/'.$c->menu_img }}">
                      </td>
                      <td>{{$c->menu_topic}}</td>
                      <td>
                        <a href="{{url('backend/edit_news_menu', $c->menu_group)}}" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i></a>
                      </td>
                    </tr>
                    @endforeach
                  </tbody>
