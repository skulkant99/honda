...
@section('title') BUSINESS-ACTIVITIES | EDIT HEADER @endsection
...
<div class="row">
    <div class="col-10">
        <div class="card">
            <div class="card-body">
              @if( empty($sRow) )
              <form action="{{ route('backend.business_header.store') }}" method="POST" enctype="multipart/form-data" autocomplete="off">
              @else
              <form action="{{ route('backend.business_header.update', $sRow[0]->id ) }}" method="POST" enctype="multipart/form-data" autocomplete="off">
...
<div class="myBorder"> 
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10 mt-2">
                      <div class="custom-control custom-switch">
                            <textarea  rows="5" name="content[]" class="form-control">{{$sRow[$i]->content??'' }}</textarea>
                      </div>
                    </div>
                </div>
 ...
 @endfor
                ...
                <div class="form-group mb-0 row">
                    <div class="col-md-6">
                        <a class="btn btn-secondary btn-sm waves-effect" href="{{ url('backend/business_header') }}">
