...
@section('title') ENVI.IMPACT | EDIT BANNER @endsection
...
<div class="row">
    <div class="col-10">
        <div class="card">
            <div class="card-body">
              @if( empty($sRow) )
              <form action="{{ route('backend.enviimpact_banner.store') }}" method="POST" enctype="multipart/form-data" autocomplete="off">
              @else
              <form action="{{ route('backend.enviimpact_banner.update', $sRow[0]->id ) }}" method="POST" enctype="multipart/form-data" autocomplete="off">
...
<div class="myBorder"> 
           ...
           <label for="example-text-input" class="col-md-2 col-form-label">Language :</label>
                 ...
                 <div class="form-group row">
                    <label for="example-text-input" class="col-md-2 col-form-label">Header2 :</label>
                    <div class="col-md-10">
                        <input class="form-control" type="text" value="{{ $sRow[$i]->header2??'' }}" name="header2[]" >
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10 mt-2">
                      <div class="custom-control custom-switch">
                            <textarea  rows="4" name="detail[]" class="ckeditor">{{$sRow[$i]->detail??'' }}</textarea>
                      </div>
                    </div>
                </div>
                        </div>
 ...
 @endfor
                ...
                <div class="form-group mb-0 row">
                    <div class="col-md-6">
                        <a class="btn btn-secondary btn-sm waves-effect" href="{{ url('backend/enviimpact_banner') }}">
