...
$(function() {
    ...
    "sDom": "<'row'<'col-sm-12'tr>><'row'<'col-sm-5'i><'col-sm-7'p>>",
        ...
        iDisplayLength: 25,
        ajax: {
          url: '{{ route('backend.triple_detail.datatable') }}',
          data: function ( d ) {
            d.Where={};
        ...
        columns: [
            ...
            {data: 'image',   title :'<center>Image</center>', className: 'text-center',render: function(d) {
               return '<img  width="200"src="{{ url("local/public/backend/triple_zero") }}/'+d+'" >';
            }},
        ...
        rowCallback: function(nRow, aData, dataIndex){
          $('td:last-child', nRow).html(''
            + '<a href="{{ route('backend.triple_detail.index') }}/'+aData['id']+'/edit" class="btn btn-sm btn-primary"><i class="bx bx-edit font-size-16 align-middle"></i></a> '
