...
@section('title') TRIPLE ZERO APPROACH | EDIT DETAIL @endsection
...
<div class="row">
    <div class="col-10">
        <div class="card">
            <div class="card-body">
              @if( empty($sRow) )
              <form action="{{ route('backend.triple_detail.store') }}" method="POST" enctype="multipart/form-data" autocomplete="off">
              @else
              <form action="{{ route('backend.triple_detail.update', $sRow[0]->id ) }}" method="POST" enctype="multipart/form-data" autocomplete="off">
...
<div class="myBorder">                
                  <div class="form-group row" >
                   ...
                   <img width="20%" id="blah" alt="your image" src="{{asset('local/public/backend/triple_zero').'/'.$sRow[0]->image??''}}">
                        </div>
                  </div>
</div>       
...
<div class="myBorder"> 
 ...
 @endfor
                ...
                <div class="form-group mb-0 row">
                    <div class="col-md-6">
                        <a class="btn btn-secondary btn-sm waves-effect" href="{{ url('backend/triple_detail') }}">
