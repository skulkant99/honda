...
@section('title') BASIC APPROACH | EDIT BASIC APPROACH @endsection
...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-0 font-size-18">EDIT BASIC APPROACH</h4>
<!-- 
...
<div class="row">
    <div class="col-10">
        <div class="card">
            <div class="card-body">
              @if( empty($sRow) )
              <form action="{{ route('backend.csr_basicapp.store') }}" method="POST" enctype="multipart/form-data" autocomplete="off">
              @else
              <form action="{{ route('backend.csr_basicapp.update', $sRow[0]->id ) }}" method="POST" enctype="multipart/form-data" autocomplete="off">
...
<div class="myBorder"> 
 ...
 @endfor
                ...
                <div class="form-group mb-0 row">
                    <div class="col-md-6">
                        <a class="btn btn-secondary btn-sm waves-effect" href="{{ url('backend/csr_basicapp') }}">
