...
<div class="row">
    <div class="col-10">
        <div class="card">
            <div class="card-body">
              @if( empty($sRow) )
              <form action="{{ route('backend.insideinformation.store') }}" method="POST" enctype="multipart/form-data" autocomplete="off">
              @else
              <form action="{{ route('backend.insideinformation.update', $sRow->id ) }}" method="POST" enctype="multipart/form-data" autocomplete="off">
              ...
              @endif
                ...
                <div class="form-group row">
                    <label for="example-text-input" class="col-md-2 col-form-label">EVALUATION RESULT :</label>
                    <div class="col-md-10">
                        <input class="form-control" type="text" value="{{ $sRow->evaluation_result??'' }}" name="evaluation_result" required>
                    </div>
                </div>

                <div class="form-group mb-0 row">
                    <div class="col-md-6">
                        <a class="btn btn-secondary btn-sm waves-effect" href="{{ url("backend/insideinformation") }}">
