...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
              @if( empty($sRow) )
              <form action="{{ route('backend.banner.store') }}" method="POST" autocomplete="off" enctype="multipart/form-data">
              @else
              <form action="{{ route('backend.banner.update', $sRow->id ) }}" method="POST" autocomplete="off" enctype="multipart/form-data">
              ...
              @endif
                ...
                <div class="form-group row">
                  <div class="col-md-7" align="center">
                    <div class="card" style="width: 13rem;">
                      ...
                      @else
                        <img class="card-img-top" src="{{ URL::asset('local/public/images/Safety/BasicApproach/Banner/'.$sRow->image??'')}} " id="blah" value="{{$sRow->image??''}}" alt="No image upload.">
                      @endif
                    </div>
                  </div>
                </div>
                ...
                <div class="form-group mb-0 row">
                    <div class="col-md-6">
                        <a class="btn btn-secondary btn-sm waves-effect" href="{{ route('backend.banner.index') }}">
