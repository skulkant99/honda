      ...
      <div class="page-title-box d-flex align-items-center justify-content-between">
        ...
        <div class="page-title-right">
          <ol class="breadcrumb m-0">
            ...
            <li class="breadcrumb-item"><a href="<?=@$path?>">Slogan</a></li>
            <li class="breadcrumb-item active">เพิ่ม/แก้ไข Slogan</li>
          </ol>
        </div>
  ...
  <div class="row">
    <div class="col-12">
      <div class="card">
        <div class="card-body">
          @if( empty($sRow) )
            <form action="{{ route('backend.slogan.store') }}" method="POST" autocomplete="off"
                  enctype="multipart/form-data">
              @else
                <form action="{{ route('backend.slogan.update', $sRow[0]->id ) }}" method="POST" autocomplete="off"
                      enctype="multipart/form-data">
              ...
              -->
                      ...
                      <div class="card" style="width: 13rem;">
                        ...
                        @else
                          <img class="card-img-top"
                               src="{{ URL::asset('local/public/images/Safety/Slogans/image/'.$sRow[0]->image??'')}} " id="blah"
                  ...
                  <div class="form-group row">
                    <div class="col-md-7" align="center">
                      <div class="card" style="width: 13rem;">
                        ...
                        @else
                          <img class="card-img-top"
                               src="{{ URL::asset('local/public/images/Safety/Slogans/image2/'.$sRow[0]->image2??'')}} " id="blah2"
                  ...
                  <div class="form-group row">
                    <div class="col-md-7" align="center">
                      <div class="card" style="width: 13rem;">
                        ...
                        @else
                          <img class="card-img-top"
                               src="{{ URL::asset('local/public/images/Safety/Slogans/image3/'.$sRow[0]->image3??'')}} " id="blah3"
                  ...
                  <div class="form-group row">
                    <div class="col-md-7" align="center">
                      <div class="card" style="width: 13rem;">
                        ...
                        @else
                          <img class="card-img-top"
                               src="{{ URL::asset('local/public/images/Safety/Slogans/image4/'.$sRow[0]->image4??'')}} " id="blah4"
                  ...
                  <div class="form-group mb-0 row">
                    <div class="col-md-6">
                      <a class="btn btn-secondary btn-sm waves-effect" href="{{ route('backend.slogan.index') }}">
