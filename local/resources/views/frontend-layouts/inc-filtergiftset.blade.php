<link rel="stylesheet" href="css/inc_filtergiftset.css">
            ...
            <div class="wrap_mainmenu loading">
                <div class="desc_cartopen">
                    ...
                    <div class="wrap_itemcart content mCustomScrollbar">
                        ...
                        <div class="box_filter">
                            <div class="topic_filter">By Gender</div>
                        ...
                        <div class="box_filter">
                            <div class="topic_filter">By Collection</div>
                            <div class="checkbox_selecttype">
                            ...
                            <div class="checkbox_selecttype2">
                                ...
                                <input type="checkbox" id="reviveArunaYouth" name="select2">
                                <label for="reviveArunaYouth">LOTUS DEFENSE™</label>
                            </div>
                        </div>
                         <div class="box_filter">
                            <div class="topic_filter">By Category</div>
                            <div class="checkbox_selecttype">
