...
class SloganController extends Controller
{
    ...
    public function index()
    {
        ...
        $image = DB::table('db_slogan')->where('lang','en')->where('group_id',1)->first();
        $detail = DB::table('db_slogan')->where('lang', $lang)->where('group_id',1)->first();
      ...
      return View('frontend.environment.environment-slogan')->with(array('image'=>$image ,'detail'=>$detail ) );
