...
class TrippleController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $banner = DB::table('db_triple_banner')->first();
        $header = DB::table('db_triple_header')->where('lang', $lang)->first();
      ...
      return View('frontend.environment.environment-tripple-zero')->with(array('banner'=>$banner ,'header'=>$header ,'detail'=>$detail ,'detail_img'=>$detail_img ,'detail2'=>$detail2 ,'detail2_img'=>$detail2_img ,'detail3'=>$detail3 ,'detail3_img'=>$detail3_img ) );
