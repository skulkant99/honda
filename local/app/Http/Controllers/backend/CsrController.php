...
class CsrController extends Controller
{
    ...
    public function form($id=NULL)
    {
      ...
      try {
         ...
         return redirect()->action('Backend\CsrController@index')->with(['alert'=>\App\Models\Alert::Msg('success')]);

      } catch (\Exception $e) {
        echo $e->getMessage();
        \DB::rollback();
        return redirect()->action('Backend\CsrController@index')->with(['alert'=>\App\Models\Alert::e($e)]);
      }
    }
